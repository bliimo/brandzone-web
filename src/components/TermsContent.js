...
export default () => {
  return (
    <div>
      ...
      <br />
      <p>&nbsp;</p>
      <p>Welcome to Brandzone Inc!</p>
      <br />
      <p>&nbsp;</p>
      <p>
        These terms and conditions outline the rules and regulations for the use of Brandzone Inc.'s
        Website, located at http://www.brandzone.ph.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use Brandzone Inc. if you do not agree to take all of the terms and conditions stated on
        this page.
      </p>
      <p>&nbsp;</p>
      <p>
        ...
        log on this website and compliant to the Company&rsquo;s terms and conditions. "The
        ...
        in the most appropriate manner for the express purpose of meeting the Client&rsquo;s needs
        in respect of provision of the Company&rsquo;s stated services, in accordance with and
      ...
      <p>
        We employ the use of cookies. By accessing Brandzone Inc., you agreed to use cookies in
        agreement with the Brandzone Inc.'s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Brandzone Inc. and/or its licensors own the intellectual property
        rights for all material on Brandzone Inc. All intellectual property rights are reserved. You
        may access this from Brandzone Inc. for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Brandzone Inc.</li>
        <li>Sell, rent or sub-license material from Brandzone Inc.</li>
        <li>Reproduce, duplicate or copy material from Brandzone Inc.</li>
        <li>Redistribute content from Brandzone Inc.</li>
      </ul>
      <p>&nbsp;</p>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and
        information in certain areas of the website. Brandzone Inc. does not filter, edit, publish
        or review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of Brandzone Inc., its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, Brandzone Inc. shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </p>
      <p>
        Brandzone Inc. reserves the right to monitor all Comments and to remove any Comments which
      ...
      <p>&nbsp;</p>
      <p>
        You hereby grant Brandzone Inc. a non-exclusive license to use, reproduce, edit and
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of Brandzone Inc.; and (d) the link is
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to Brandzone Inc. Please
      ...
      <ul>
        ...
        <li>
          ...
          context and format of content on the linking party&rsquo;s site.
        </li>
      </ul>
      <p>&nbsp;</p>
      <p>
        No use of Brandzone Inc.'s logo or other artwork will be allowed for linking absent a
      ...
      <p>
        ...
        reserve the right to amen these terms and conditions and it&rsquo;s linking policy at any
