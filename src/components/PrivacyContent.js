    ...
    <div className='content'>
      ...
      <ul>
        ...
        <li>
          ...
          "We", "Us" or "Our" in this Agreement) refers to Brandzone Inc., 5388
          Curie St., Brgy. Palanan, Makati, 1235 Metro Manila. 
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong>&nbsp;refers to Brandzone site name,
          accessible from (<strong>http://www.brandzone.ph)</strong>
        </li>
        <li>
      ...
      <p>
        ...
        <strong>
          <a href='http://www.brandzone.ph/CONTACTUS'>
            http://www.brandzone.ph/CONTACTUS
          </a>
        </strong>
        <strong>)</strong>
      </p>
