...
export default () => {
  return (
    <div className='content'>
      ...
      <br />
      <p>Last updated: January DAY, 2020</p>
      <p>&nbsp;</p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Brandzone Inc., 5388 Curie St., Brgy. Palanan, Makati, 1235
          Metro Manila. 
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong>&nbsp;refers to Brandzone site name, accessible from (
          <strong>http://www.brandzone.ph)</strong>
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Necessary / Essential Cookies</strong> Type: Session Cookies Administered by:
          Us Purpose: These Cookies are essential to provide You with services available through the
        ...
        <li>
          ...
          Cookies Administered by: Us Purpose: These Cookies identify if users have accepted the use
          of cookies on the Website. 
        </li>
        <li>
          <strong>Functionality Cookies</strong> Type: Persistent Cookies Administered by:
          Us Purpose: These Cookies allow us to remember choices You make when You use the Website,
      ...
      <ul>
        <li>
          ...
          Service Providers to monitor and analyze the use of our Service, to show advertisements to
          You to help support and maintain Our Service, to contact You, to advertise on third party
        ...
        <li>
          ...
          Service may see You name, profile, pictures and description of Your activity. Similarly,
      ...
      <p>
        ...
        and 18 years old. In some cases, this means We will be unable to provide certain
      ...
      <p>
        ...
        <strong>
          <a href='http://www.brandzone.ph/CONTACTUS'>http://www.brandzone.ph/CONTACTUS</a>
        </strong>
        <strong>)</strong>
      </p>
      <p>
